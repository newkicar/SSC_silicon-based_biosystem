...
ROSTER_API_URL = "http://{{SAP_API_HOST}}:8080/system/sap/querySapRoster"
ROSTER_AUTH_CODE = "{{SAP_AUTH_CODE_ROSTER}}"
ROSTER_PUBLIC_KEY = """{{RSA_PUBLIC_KEY_ROSTER}}"""

ATTENDANCE_API_URL = "http://{{SAP_API_HOST}}:8080/system/sap/queryAttendance"
ATTENDANCE_AUTH_CODE = "{{SAP_AUTH_CODE_ATTENDANCE}}"
ATTENDANCE_PUBLIC_KEY = "{{RSA_PUBLIC_KEY_ATTENDANCE}}"
